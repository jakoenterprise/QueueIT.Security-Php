...
require_once(Mage::getBaseDir('lib') . '/QueueIT.Security-Php/QueueIT.Security/SessionValidationController.php');
...
class Mage_Core_Controller_Varien_Front extends Varien_Object
{
    ...
    protected function _validateSession() {
        if (empty($_SERVER) ||
                ...
                strpos($_SERVER['HTTP_HOST'], 'admin.kicksusa.') !== false) {
            return;
        }
	...
	//beginning of custom code for queue-it 
        $this->_validateSession();
        //end of custom code for queue-it
